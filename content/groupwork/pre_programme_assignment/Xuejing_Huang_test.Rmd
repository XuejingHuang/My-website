...
Snowball is a [ragdoll](https://en.wikipedia.org/wiki/Ragdoll). She is now one and half years old and she has a pair of beautiful blue eyes![distinctive blue eyes](/images/IMG_4351.jpeg)
...
plot1<- plot1 +
labs(title = "Life expectancy over time in Greece ",
x = "time",
y = " no. of years ") +
NULL
...
The life expectancy is positively correlated to the GDP of a country
...
labs(title = "leave_share in UK_histogram",
x = "leave_share in %",
y = "no. of constituencies") +NULL

# density plot-- think smoothed histogram
ggplot(brexit_results, aes(x = leave_share)) +
  geom_density()+
  labs(title = "leave_share in UK_density plot",
x = "leave_share in %",
y = "density") +NULL
...
ggplot(brexit_results, aes(x = leave_share)) +
  ...
  labs(title = "leave_share in UK_ECDF",
x = "leave_share in %",
y = "cumulative probability") +NULL
...
ggplot(brexit_results, aes(x = born_in_uk, y = leave_share)) +
  geom_point(alpha=0.3) +
    labs(title = "leave_share in UK_scatter plot",
x = "voters born in UK %",
y = "leave_share in %")+
...
For most constituencies, over 80% of the voters are born in UK, and the leave_share tends to be higher.  
...
for most animal groups, the mean of incident cost is higher than the median, which indicates the cost for most incidents gathers to the lower end
...
I think the box plot is the best to show the variability of incident notional cost, because it evens the effect of the coordinate steps and directly reflects the area where most cases concentrate. for example, for ferret the cost is very concentrated , while for foxes it's highly scattered and could be very expensive to rescue
...
-   What, if anything, gave you the most trouble: debugging on syntax compiling. In the end I re-installed the packages and Mac tex and it can finally run properly